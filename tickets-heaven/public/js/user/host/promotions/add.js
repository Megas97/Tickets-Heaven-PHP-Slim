let _Add_Host_Promo_Code;

jQuery(document).ready(() => {
    _Add_Host_Promo_Code.init();
});

(($ => {

    _Add_Host_Promo_Code = {
        ...
        init() {
            ...
            addPromoCodeButton.on('click', function (e) {
                ...
                _Add_Host_Promo_Code.xhr = $.ajax({
                    url: '/host/promotions/add',
                    type: 'POST',
                    contentType: false,
                    processData: false,
                    data: form,
                    beforeSend() {
                        if (_Add_Host_Promo_Code.xhr !== false) {
                            _Add_Host_Promo_Code.xhr.abort();
                        }
                    }
                }).done(response => {
