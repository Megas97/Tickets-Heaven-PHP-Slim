let _View_Host_Promo_Code;

jQuery(document).ready(() => {
    _View_Host_Promo_Code.init();
});

(($ => {
    
    _View_Host_Promo_Code = {
        ...
        init() {
            ...
            updatePromoCodeButton.on('click', function (e) {
                ...
                _View_Host_Promo_Code.xhr = $.ajax({
                    url: '/host/promotions/' + $('#current-id').val(),
                    type: 'POST',
                    contentType: false,
                    processData: false,
                    data: form,
                    beforeSend() {
                        if (_View_Host_Promo_Code.xhr !== false) {
                            _View_Host_Promo_Code.xhr.abort();
                        }
                    }
                }).done(response => {
