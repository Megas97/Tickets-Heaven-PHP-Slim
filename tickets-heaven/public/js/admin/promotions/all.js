let _All_Promo_Codes;

jQuery(document).ready(() => {
    _All_Promo_Codes.init();
});
    ...
    _All_Promo_Codes = {
        ...
        init() {
            ...
            addPromoCodeButton.on('click', function (e) {
                ...
                location.href = base_url + '/admin/promotions/add';
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                _All_Promo_Codes.xhr = $.ajax({
                                    ...
                                    beforeSend() {
                                        if (_All_Promo_Codes.xhr !== false) {
                                            _All_Promo_Codes.xhr.abort();
                                        }
                                    }
                                }).done(response => {
